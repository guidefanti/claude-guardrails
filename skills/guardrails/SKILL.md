...
name: guardrails
description: >
  Core cognitive guardrails that prevent common LLM failures. Load this skill
  before any task involving implementation, analysis, research, planning,
  estimation, debugging, deployment, or any deliverable where correctness matters.
  Covers: anti-hallucination, verification before claiming done, scope discipline,
  clarity before execution, pressure testing, and project self-improvement logging.
  This skill applies universally to code, marketing, automation, research,
  strategy, and content tasks.
---

# Guardrails

Core cognitive constraints that prevent predictable LLM failures.
These are not suggestions — they are corrective rules derived from real failure patterns.
...
## Skill routing
- For development/coding tasks: also load dev-guardrails (if available in the project).
- For analysis, research, strategy, planning, or marketing tasks: also load universal-thinking.
